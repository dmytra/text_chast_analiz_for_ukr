    ...
    : QWidget(parent)
{
        ...
        QLabel * lbl = new QLabel("<b>ЧАСТОТНИЙ АНАЛІЗ</b> (тільки українські букви)!");
        ...
        bottomLayoutL1->addWidget(lblSaveObject);
        bottomLayoutL2->addWidget(insertSaveObjectButton);
...
//        }
        ...
        for(int i=0; i < 32; i++)
        {
        if(((i+1) % 10) == 0 ) {strStatLabelSUM = strStatLabelSUM + strStatLabel[i] + " =\t" + QString::number(alphabet[i]) + "\n";}
